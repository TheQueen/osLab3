...
client: client.c
	gcc -Wall -g client.c wrapper.c planetDisplayList.c -I/usr/include/cairo -L/usr/include/lib/ `pkg-config --cflags gtk+-3.0` -lcairo -o client `pkg-config --libs gtk+-3.0` -lpthread -lrt -std=gnu11
